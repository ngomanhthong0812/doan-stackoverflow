...
export default function FolderDetail({ folder }) {
  if (!folder)
    return (
  ...
  return (
    <div className="flex-1 p-6 bg-white overflow-y-auto">
      <div className="mb-8 border-b pb-6">
        <h3 className="text-2xl font-bold text-gray-900 mb-2">{folder.title}</h3>
      ...
      <div>
        ...
        {folder.files.length === 0 ? (
          <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200">
            <p className="text-gray-500 text-sm">No files in this folder yet.</p>
          </div>
        ) : (
